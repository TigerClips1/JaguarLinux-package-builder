/* pbuild-tar.c - A TAR mangling utility for .ps4 packages
 *
...
"pbuild-tar " VERSION "\n"
"\n"
"usage: pbuild-tar [--hash[=<algorithm>]] [--cut]\n"
"\n"
"options:\n"
...
static int do_it(const EVP_MD *md, int cut)
{
	...
	if (md) snprintf(checksumhdr, sizeof(checksumhdr), "PS4-TOOLS.checksum.%s", EVP_MD_name(md));
